                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="modal-bg">
                                ...
                                <div class="offer-content"> <img src="/assets-front/images/Offer-banner.png" class="img-fluid blur-up lazyload" alt="">
                                    <h2>newsletter</h2>
                                    <form action="https://pixelstrap.us19.list-manage.com/subscribe/post?u=5a128856334b598b395f1fc9b&amp;id=082f74cbda" class="auth-form needs-validation" method="post" id="mc-embedded-subscribe-form1" name="mc-embedded-subscribe-form1" target="_blank">
                                        <div class="form-group mx-sm-3">
                                            <input type="email" class="form-control" name="EMAIL" id="mce-EMAIL1" placeholder="Enter your email" required="required">
    ...
    <div class="setting_box_body">
        ...
        <div class="setting-body">
            ...
            <div class="buy_btn">
                ...
                <a href="https://themeforest.net/item/multikart-responsive-angular-ecommerce-template/22905358?s_rank=3" target="_blank" class="btn btn-block purchase_btn"><img src="/assets-front/images/icon/angular.png" alt="" class="img-fluid"> Multikart Angular</a>
                <a href="https://themeforest.net/item/multikart-responsive-react-ecommerce-template/23067773?s_rank=2" target="_blank" class="btn btn-block purchase_btn"><img src="/assets-front/images/icon/react.png" alt="" class="img-fluid"> Multikart React</a>
                <a href="https://themeforest.net/item/multikart-multipurpose-shopify-sections-theme/23093831?s_rank=1" target="_blank" class="btn btn-block purchase_btn"><img src="/assets-front/images/icon/shopify.png" alt="" class="img-fluid"> Multikart Shopify</a>
            </div>
        </div>
    </div>
</div> --}}
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="modal-bg">
                                ...
                                <div class="media">
                                    <img src="/assets-front/images/stop.png" class="stop img-fluid blur-up lazyload mr-3" alt="">
