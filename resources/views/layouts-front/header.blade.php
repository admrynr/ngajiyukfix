                ...
                <div class="main-menu">
                    <div class="menu-left">
                        ...
                        <div class="brand-logo">
                            <a href="{{url('/')}}"><img src="/images/bliomi-logo.png" class="img-fluid blur-up lazyload" alt="" style="height:45px"></a>
                        </div>
                    </div>
                        ...
                        <div>
                            <nav id="main-nav">
                                ...
                                <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                    ...
                                    {{-- <li>
                                        <a href="{{ route('auction') }}" {{ Request::segment(1) == 'auction' ? 'class=active' : '' }}>Auction</a>
                                    </li> --}}
                                    <li>
                            ...
                            <div class="icon-nav">
                                <ul>
                                    ...
                                    <li class="onhover-div mobile-cart">
                                            <div href="javascript:void(0)" onclick="openCart()" ><img src="{{asset('assets-front/images/icon/cart.png')}}" class="img-fluid blur-up lazyload" alt="">
