...
<!-- breadcrumb end -->
    ...
    <section class="tab-product section-b-space  vertical-tab">
...
$(document).ready(function() {
        @foreach($product as $jav)
            ...
            @endif
        @endforeach
        $('.auctionvalue').on('change',function(){
            val = $(this).val();
            id = $(this).data('id');
            alert(val);
            if(val == '0000'){
                ...
                $.ajax({
                    ...
                    type: 'GET',
                    success: function(data){
                        $('.timer'+id).css('display','none');
                        if(data.status == 4){
                            $('#auctionfailed'+id).css('display','block');
                        }else{
                            $('#auctionsuccess'+id).css('display','block');
                        }
