                ...
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" >
                            <tr>
                                <td>
                                    <img src="{{asset("assets-front/images/email-temp/delivery.png")}}" alt="" style=";margin-bottom: 30px;">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                  ...
                                  @endif
                                  <p>Transaction ID : <span class="text-primary">{{ $data['transaction']->invoice_number }}</span></p>
                                  <p>Transaction Status : <span {{ $data['transaction']->status == 1 ? 'class=bg-primary text-white' : 'class:bg-info text-white' }}>{{ $data['transaction']->status == 1 ? 'Waiting for payment' : 'Transaction Success' }}</span></p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <img src="{{asset("assets-front/images/email-temp/order-success.png")}}" alt="" style="margin-top: 30px;">
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="order-detail" border="0" cellpadding="0" cellspacing="0"  align="left">
                            ...
                            @foreach($data['detailtransaction'] as $tran)
                            <tr>
                                <td>
                                    <img src="{{url('images/'.$tran->product->image)}}" alt="" width="70">
                                </td>
                                <td valign="top" style="padding-left: 15px;">
                                    <h5 style="margin-top: 15px;">{{ $tran->product->product_name }}</h5>
                                </td>
                                <td valign="top" style="padding-left: 15px;">
                                    <h5 style="margin-top: 15px;">{!!$tran->product->product_description!!}</h5>
                                </td>
                                <td valign="top" style="padding-left: 15px;">
                                    <h5 style="font-size: 14px; color:#444;margin-top: 10px;">QTY : <span>{{ $tran->qty }}</span></h5>
                                </td>
                                <td valign="top" style="padding-left: 15px;">
                                    <h5 style="font-size: 14px; color:#444;margin-top:15px"><b>IDR {{ number_format($tran->product->final_price) }}</b></h5>
                                </td>
                            </tr>
                            @endforeach
                            <tr>
                                <td colspan="2" style="line-height: 49px;font-size: 13px;color: #000000;padding-left: 20px;text-align:left;border-right: unset;">Products:</td>
                                    <td colspan="3" class="price" style="line-height: 49px;text-align: right;padding-right: 28px;font-size: 13px;color: #000000;text-align:right;border-left: unset;"><b>IDR {{ number_format($data['transaction']->total_final_price) }}</b></td>
                            </tr>
                            <tr>
                                <td colspan="2" style="line-height: 49px;font-size: 13px;color: #000000;
                                    ...
                                    <td colspan="3" class="price" style="
                                        line-height: 49px;text-align: right;padding-right: 28px;font-size: 13px;color: #000000;text-align:right;border-left: unset;"><b>IDR {{ number_format($data['transaction']->shipping_price) }}</b></td>
                            </tr>
                            <tr>
                                <td colspan="2" style="line-height: 49px;font-size: 13px;color: #000000;
                                    padding-left: 20px;text-align:left;border-right: unset;">Tax :</td>
                                    <td colspan="3" class="price" style="
                                        line-height: 49px;text-align: right;padding-right: 28px;font-size: 13px;color: #000000;text-align:right;border-left: unset;"><b>IDR {{ number_format($data['transaction']->tax) }}</b></td>
                            </tr>
                            <tr>
                                <td colspan="2" style="line-height: 49px;font-size: 13px;color: #000000;
                                    padding-left: 20px;text-align:left;border-right: unset;">TOTAL PAID :</td>
                                    <td colspan="3" class="price" style="line-height: 49px;text-align: right;padding-right: 28px;font-size: 13px;color: #000000;text-align:right;border-left: unset;"><b>IDR {{ number_format($data['transaction']->total_price) }}</b></td>
                            </tr>
                        </table>
                        <table cellpadding="0" cellspacing="0" border="0" align="left" style="width: 100%;margin-top: 30px;    margin-bottom: 30px;">
                                    <tbody><tr>
                                        <td style="font-size: 13px; font-weight: 400; color: #444444; letter-spacing: 0.2px;width: 50%;">
                                            ...
                                            <p style="text-align: left;font-weight: normal; font-size: 14px; color: #000000;line-height: 21px;    margin-top: 0;">Receiver : {{ $data['transaction']->receiver_name }}<br>Address : {{ $data['transaction']->address }} <br>Courier : {{ $data['transaction']->shipping_type }}<br>Estimate time : {{ $data['transaction']->estimate_date }} Days</p>
                                        </td>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" align="left" style="width: 100%;margin-top: 30px;    margin-bottom: 30px;">
                                            <tbody><tr>
                                                <td style="font-size: 13px; font-weight: 400; color: #444444; letter-spacing: 0.2px;width: 50%;">
                                                    <h5 style="font-size: 16px; font-weight: 500;color: #000; line-height: 16px; padding-bottom: 13px; border-bottom: 1px solid #e6e8eb; letter-spacing: -0.65px; margin-top:0; margin-bottom: 13px;">PAYMENT METHOD</h5>
                                                    <p style="text-align: left;font-weight: normal; font-size: 14px; color: #000000;line-height: 21px;    margin-top: 0;">See More Instruction, <a href="{{ $data['transaction']->midtrans_pdf_url }}" target="_blank">here</a>.</p>
                                                </td>
                                ...
                                <td style="padding: 30px;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="footer-social-icon" align="center" class="text-center" style="margin-top:20px;">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"><img src="{{asset("assets-front/images/email-temp/gplus.png")}}" alt=""></a>
                                            </td>
                                            <td>
                                                <a href="#"><img src="{{asset("assets-front/images/email-temp/linkedin.png")}}" alt=""></a>
                                            </td>
                                            <td>
                                                <a href="#"><img src="{{asset("assets-front/images/email-temp/pinterest.png")}}" alt=""></a>
                                            </td>
                                        </tr>
                                    </table>
