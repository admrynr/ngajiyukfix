                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <div class="dashboard-right">
                                <div class="dashboard">
                                    <div class="page-title">
                                    <h2>Order Detail <a href="{{ route('orderhistory') }}" class="pull-right"><h5 style="margin-top:-7px" class="text-primary">Order History ({{$tran->where('status','>',1)->count()}})</h5></a></h2>
                                        
                                    </div>
                                    <div class="welcome-msg">
                                        <p>Hello, {{$user->name}} ! Check your order here.</p>
                                        <h6>You have <a href="#">{{$tran->where('status',1)->count()}}</a> unprocessed order. Have a look at it.</h6>
