                ...
                <div class="card m-b-20">
                    <div class="card-body">
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <div id="dropdownCategory" class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <input type="text" class="form-control" placeholder="Search.." id="inputCategory" onkeyup="filterFunctionCats()">
                            <a href="{{ route('product.index') }}" class="dropdown-item">All (<span id="totalcats"></span>)</a>
                            @foreach ($categories as $c)
                            <a href="{{ route('product.index') }}?filter={{$c->name}}"  class="dropdown-item">{{$c->name}} (<span id="{{$c->name}}"></span>)</a>
                            @endforeach
                            <input type="hidden" id="filter" value="{{ empty(Request::get('filter')) ? 'all' : Request::get('filter') }}">
                        </div>
                    </div>
        ...
        <div class="col-xl-12">
            <div class="card m-b-20">
                <div class="card-body">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 33px, 0px);">
                                    ...
                                    <a class="dropdown-item dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      ...
                                      <div id="myDropdown" class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <a href="#" class="dropdown-item bulk-button" data-title="{{$cat->name}}">{{$cat->name}}</a>
                                        @endforeach
                                      </div>                                
                                    </div>
                    ...
                    <div class="col-md-6 text-right">
                    <a class="pull-right" href="{{ route('product.create') }}" >
                        <span class="btn btn-rounded btn-success waves-effect waves-light">
                            <i class="ti-plus"></i> Create Product
                        </span>
                        </a>
                    </div>
                    </div>
